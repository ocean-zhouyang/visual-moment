...
public class SwaggerConfig {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)  // DocumentationType.SWAGGER_2 固定的，代表swagger2
                ...
                // 扫描指定包下的接口，最为常用
                .apis(RequestHandlerSelectors.basePackage("com.sjsk.passjava"))
    ...
    private ApiInfo apiInfo() {
        ...
        Contact contact = new Contact(
                ...
                "930328459@qq.com"); // 作者邮箱

        return new ApiInfoBuilder()
                .title("原型项目API") //  可以用来自定义API的主标题
                .description("测试相关组件用法") // 可以用来描述整体的API
                .termsOfServiceUrl("https://www.baidu.com") // 用于定义服务的域名（跳转链接）
                .version("1.0") // 可以用来定义版本
                .license("Swagger-的使用教程")
                .licenseUrl("https://blog.csdn.net/qq_27480007/article/details/132656505")
                .contact(contact)
                .build();
    }
}
